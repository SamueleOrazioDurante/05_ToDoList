    ...
    <div class="w-full rounded-lg bg-white shadow sm:max-w-md md:mt-0 xl:p-0 dark:border dark:border-gray-700 dark:bg-gray-800">
      <div class="space-y-4 p-6 sm:p-8 md:space-y-6">
        ...
        <form class="space-y-4 md:space-y-6" action="#">
          ...
          <p class="text-sm font-light text-gray-500 dark:text-gray-400">Non hai ancora un account? <a href="signup.jsp" class="text-primary-600 dark:text-primary-500 font-medium hover:underline">Iscriviti</a></p>
        </form>
      </div>
    </div>
  </div>
